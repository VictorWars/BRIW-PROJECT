...
class GeneratorQuerySolr
{
    ...
    private $baseQuery = 'http://localhost:8983/solr/proyecto_final/selectCheck?debug.explain.structured=true&debugQuery=on&df=attr_text&hl.fl=attr_text&hl=true&q=';
